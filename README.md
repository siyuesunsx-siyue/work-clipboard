...
Work Clipboard 是一个本地优先的 Chrome 扩展，用来在电脑工作时临时保存复制的文本、链接、截图和文件信息。
...
1. 点击 Chrome 右上角的 Work Clipboard 扩展图标
2. 在任意软件里按 `Ctrl+C` 复制文本
3. 使用 `Win+Shift+S` 截图
4. 回到 Work Clipboard 页面查看、搜索、复制、保存或删除
